  ...
  return (
    <motion.div
      className={cn(
        ...
        "backdrop-blur-lg  dark:bg-black/30"
      )}
    ...
    >
      <motion.div
        className={`relative z-40 flex text-muted-foreground h-full shrink-0 flex-col bg-white/30 dark:bg-black/30 backdrop-blur-lg transition-all`}
        variants={contentVariants}
      >
        <motion.ul variants={staggerVariants} className="flex h-full flex-col">
          <div className="flex grow flex-col items-center   backdrop-blur-xl">
              ...
              <div className="mt-[1.5px] flex w-full">
                <Button variant="ghost" size="sm" className="flex w-fit items-center gap-2 px-2">
                  ...
                  <motion.li variants={variants} className="flex w-fit items-center gap-2">
                    {!isCollapsed && (
                      <>
                        <p className="text-sm font-medium">{"InstaChat"}</p>
                      </>
                    )}
                  </motion.li>
                </Button>
